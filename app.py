...
app.config['CORS_RESOURCES'] ={r"/recSys/api/*": {"origins": "*"}}
...
@app.route('/recSys/api/user', methods=['GET'])
def get_all_users():
...
@app.route('/recSys/api/user/<sfu_id>', methods=['GET'])
...
@app.route('/recSys/api/user', methods=['POST'])
def create_user():
...
@app.route('/recSys/api/highlight', methods=['POST'])
def add_highlights():
    data = request.get_json()
    userid = data['sfu_id']
...
@app.route('/recSys/api/display-recommendations/<sfu_id>', methods=['GET'])
...
@app.route('/recSys/api/highlight/<sfu_id>', methods=['GET'])
...
@app.route('/recSys/api/users-highlights', methods=['GET'])
...
api_manager.create_api(Highlights)
api_manager.create_api(Saved_Recommendations)
